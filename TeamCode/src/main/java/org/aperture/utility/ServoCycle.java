...
@TeleOp(name="Servo Cycle", group="teleop")
//@Disabled
public class ServoCycle extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        CachedServo[] servos = { robot.clawServo, robot.wristServo, robot.elbowServo,
                robot.intakeServo,
                robot.slServo, robot.srServo };
        String[] names = { "claw", "wrist", "elbow", "intake", "shoulderLeft", "shoulderRight" };
